...
"안녕하세요. 현대오토에버 최병민입니다. 오늘은 AI 에이전트의 행동을 어떻게 통제할 수 있는지 이야기하겠습니다."

"그리고 제가 만든 SlackOps DevOps Agent를 사례로 들어, 읽기는 기본적으로 제한하고 변경은 사람이 승인하는 구조를 실제 구현과 거부 결과, 그리고 라이브 시연으로 보여드리겠습니다."
